...
if (Modernizr.webgl) {
  ...
  function ready(error, config, data) {
    ...
    map.on('load', function() {
      ...
      //   paint: {
      //     'fill-color': ['case',
      //       ['!=', ['feature-state', 'colourvalue1'], null],
      //       "yellow"
      //       ['==', []]
      //       ['feature-state', 'colourvalue1'],
      //       'rgba(255, 255, 255, 0)'
      //     ],
      ...
      //loop the json data and set feature state for layers
      //for (var key in json) {
        ...
        var selectedDate = "07/03/2020";

        console.log(json);

        //var thisAreaData = json[key];

        var dataForDate = json[selectedDate];
    ...
    $("#forward").click(function(event) {
      ...
      //changing it by moving through the featurestates - does not seem as responsive (counter intuitively)
      map.setPaintProperty(
        "area-boundaries",
        'fill-color', ['case',
            ['!=', ['feature-state', 'colourvalue'+ displayedData], null],
            ['feature-state', 'colourvalue' + displayedData],
            'rgba(255, 255, 255, 0)'
        ],
        'fill-color-transition', {duration: 500, delay:500}
      )


      // //changing by updating the "colour" feature state
      // for (var key in json) {
