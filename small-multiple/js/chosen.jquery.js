...
<div class="chosen-drop">
  ...
  <li class="search-field">
    <input class="chosen-search-input" aria-label="${this.default_text}" type="text" autocomplete="off" role="combobox" placeholder="${this.default_text}" aria-expanded="false" aria-haspopup="true" aria-autocomplete="list" />
  </li>
</ul>
<div class="chosen-drop">
  <ul class="chosen-results" role="listbox"></ul>
